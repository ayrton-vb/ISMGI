...
@section('content')
<h1 class="text-center">Tipo de Actas</h1>
    <a href="tipoactas/create" class="btn btn-dark mb-2">Crear</a>
            ...
            <tr>
                ...
                <td>
                   <form action="{{ route ('tipoactas.destroy',$tipoacta->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <a href="/tipoactas/{{$tipoacta->id}}/edit" class="btn btn-info">Editar</a>

...
@section('content')
<form action="/actorinstitucionals/{{$actorinstitucional->id}}" method="POST">
        @csrf
        @method('PUT')
        <h1 class="text-center">Editar  Actor Institucional</h1>
        <div class="container">
            <div class="row">
                <div class="col-6">
                ...
                <div class="mb-3">
                    ...
                    <select  id="id_actor" name="id_actor" class="form-select" aria-label="Default select example" tabindex="1">
                        <option  value="{{$actorinstitucional->id_actor}}">{{$actorinstitucional->actors->nombre}}</option>
                    ...
                    <select  id="id_cargoinstitucional" name="id_cargoinstitucional" class="form-select" aria-label="Default select example" tabindex="1">
                        <option  value="{{$actorinstitucional->id_cargoinstitucional}}">{{$actorinstitucional->cargoinstitucionals->nombre}}</option>
                    ...
                    <select  id="id_institucion" name="id_institucion" class="form-select" aria-label="Default select example" tabindex="1">
                        <option  value="{{$actorinstitucional->id_institucion}}">{{$actorinstitucional->institucions->nombre}}</option>

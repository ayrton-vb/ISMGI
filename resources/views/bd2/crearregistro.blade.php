    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                ...
                <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Historial Externo</label>
                    <select  id="id_historialactorexterno" name="id_historialactorexterno" class="form-select" aria-label="Default select example" tabindex="1">
                        <option  value="">-Selecciona-</option>
                        @foreach($historialexternos as $historialexterno)
                            <option  value="{{$historialexterno->id}}">{{$historialexterno->actors->nombre}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">

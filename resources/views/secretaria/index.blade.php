...
@section('content')
<h1 class="text-center">Secretarias</h1>
    <a href="secretarias/create" class="btn btn-dark mb-2">Crear</a>
            ...
            <tr>
                ...
                <td>
                   <form action="{{ route ('secretarias.destroy',$secretaria->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <a href="/secretarias/{{$secretaria->id}}/edit" class="btn btn-info">Editar</a>

...
<!-- seccion mesa directiva de la fejuve -->
<seccion id="directivaFejuve">
<h1 class="text-center">Mesa Directiva {{$organizacion->sigla}} </h1>
        <div class="text-center">
            ...
            <a href="#directivaListaFejuve" type="button" class="btn btn-danger mb-2">Lista</a>
            <a href="#directivaEjecutivoFejuve" type="button" class="btn btn-info mb-2">Secretarios de Organizacion</a>
        </div>
...
<!-- seccion mesa directiva de la lista fejuve -->
<seccion id="directivaListaFejuve">
<h1 class="text-center">Lista</h1>
<div class="text-center">
<a href="#directivaFejuve" type="button" class="btn btn-danger mb-2">Mesa Directiva</a>
</div>              
...
<!-- seccion mesa directiva de la Ejecutivos fejuve -->

<seccion id="directivaEjecutivoFejuve">
        <h1 class="text-center">Secretarios de Organizacion {{$organizacion->sigla}} </h1>
        <div class="text-center">
            <!-- <a href="/pdf/{{$organizacion->id}}/pdfActoresbyOrganizacion" type="button" class="btn btn-dark mb-2">Lista</a> -->
            <!-- <a href="/pdf/{{$organizacion->id}}/pdfActoresbyOrganizacionReconocimiento" type="button" class="btn btn-secondary mb-2">Reconocimiento</a> -->
            <a href="#directivaListaEjecutivoFejuve" type="button" class="btn btn-danger mb-2">Lista</a>
            <a href="#directivaFejuve" type="button" class="btn btn-info mb-2">Mesa Directiva</a>
...
<!-- seccion mesa directiva de la lista ejecutivos fejuve -->   
<seccion id="directivaListaEjecutivoFejuve">
<h1 class="text-center">Lista</h1>
<div class="text-center">
            <a href="#directivaEjecutivoFejuve" type="button" class="btn btn-danger mb-2">Secretarios de Organizacion</a>
</div>      
            <table id="table2" class="table table-light table-striped mt-4">
                <thead class="table-dark">
                <tr>
                    <th>Id</th>
                    <th>Nombre</th>

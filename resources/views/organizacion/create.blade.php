        ...
        <div class="row">
            <div class="col-6">
                ...
                <div class="mb-3">
                        ...
                        <input id="fundacion" name="fundacion" type="text" class="form-control" tabindex="1">
                    </div>
                    <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input id="dependencia" name="dependencia" type="text" class="form-control" tabindex="1">
                </div>
